  ...
  imports: [
    ...
    TypeOrmModule.forRootAsync({
      ...
      useFactory: async (configService: ConfigService) => ({
        ...
        entities: [ProfileEntity, ProfileStripeAccountEntity],
        synchronize: false,
      }),
      inject: [ConfigService],
    }),
    ...
    TypeOrmModule.forFeature(
      [ProfileEntity, ProfileStripeAccountEntity],
      'profiles',
    ),
    TypeOrmModule.forFeature([ProductEntity, ProfileProductEntity], 'products'),
  ],
